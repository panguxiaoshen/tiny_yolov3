...
# Set the class name
__C.YOLO.CLASSES                = "./data/classes/hand.names"
__C.YOLO.ANCHORS                = "./data/anchors/coco_anchors.txt"
__C.YOLO.TINY_ANCHORS           = "./data/anchors/tiny_yolo_anchors.txt"
__C.YOLO.MOVING_AVE_DECAY       = 0.9
__C.YOLO.STRIDES                = [8, 16, 32]
__C.YOLO.TINY_STRIDES           = [16, 32]
...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/company_call_hand_yolov3_train.txt"
__C.TRAIN.BATCH_SIZE            = 128
# __C.TRAIN.INPUT_SIZE            = [320, 352, 384, 416, 448, 480, 512, 544, 576, 608]
__C.TRAIN.INPUT_SIZE            = [160]#, 192, 224, 256, 288, 320]
...
__C.TRAIN.INITIAL_WEIGHT        = "./checkpoint/bu-0719/yolov3_test_loss=0.3038.ckpt-30"
...
__C.TEST.ANNOT_PATH             = "./data/dataset/company_call_hand_yolov3_test.txt"
