...
#
#   Editor      : hh
#   File name   : train_tiny.py
#   Author      : LMY1994
#   Created date: 2019-07-09 18:07:55
#   Description :
#
#================================================================
...
class YoloTrain(object):
    def __init__(self):
        ...
        with tf.name_scope("define_loss"):
            self.model = YOLOV3_TINY(self.input_data, self.trainable)
        ...
        with tf.name_scope("define_second_stage_train"):
            ...
            # tf.contrib.quantize.create_training_graph(input_graph = self.sess.graph,quant_delay=2)
    ...
    def train(self):
        ...
        for epoch in range(1, 1+self.first_stage_epochs+self.second_stage_epochs):
            ...
            tf.train.write_graph(self.sess.graph_def, './checkpoint/','fakequantize.pbtxt', True)
